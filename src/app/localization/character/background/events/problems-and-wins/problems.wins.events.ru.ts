...
export class ProblemsWinsEventsLocalizationRu implements ProblemsWinsEventsLocalization {
  ...
  getDisasterByRoll(roll: number) {
    switch (roll) {
      case 1:
        return 'Финансовые потери или задолженность. Вы потеряли '
      ...
      case 2:
        return 'Заключение: вы сидели в тюрьме, ' +
          'либо отрабатывал проступки перед законом (на свой выбор) на протяжении '
          + this.getImprisonment() + ' месяцев.';
      case 3:
        return 'Болезнь или пагубная привычка: за это время вы заболели ' +
          'или пристрастились к наркотикам. ' +
          'В результате навсегда теряете 1 очко REF.';
      case 4:
        return 'Предательство: тебя подставили следующим образом: ' +
          this.getBetrayal();
      case 5:
        return 'Несчастный случай: вы попали в ужасную аварию. ' +
          this.getAccident();
      case 6:
        return 'Возлюбленный, друг или родственник убиты: ' +
          'вы потеряли кого-то действительно дорогого. ' + this.getRelativeKilled();
      case 7:
        return 'Ложное обвинение: вас подставили. ' +
          this.getFalseAccusation();
      case 8:
        return 'Неприятности с законом: вы объявлены в розыск ' +
          '(за преступление которое вы совершали, или не совершали (на ваш выбор)). ' +
          this.getHuntedLaw();
      case 9:
        return 'За вами охотится корпорация: вы рассердили корпоративного босса. ' +
  ...
  private getBetrayal() {
    switch (this.d10.roll()) {
      ...
      case 2:
      case 3:
        return 'вас шантажировали.';
      case 4:
      case 5:
      case 6:
      case 7:
        return 'была раскрыта ваша тайна.';
      case 8:
      case 9:
      case 10:
        return 'вас предал близкий друг: увёл возлюбленного' +
          ' или кинул по карьерной линии (на ваш выбор).';
    }
  }
  ...
  private getAccident() {
    switch (this.d10.roll()) {
      ...
      case 3:
      case 4:
        return 'вы были ужасно обезображены и должны вычесть -5 из своей ATT.';
      case 5:
      case 6:
        return 'Вы были госпитализированы на ' + this.d10.roll() + ' месяцев в этом году.';
      case 7:
      case 8:
        return 'Вы потеряли ' + this.d10.roll() + ' месяцев памяти из этого года.';
      case 9:
      case 10:
        return 'Вам постоянно снятся кошмары (каждую ночь шанс 8 из 10), ' +
          'связанные с аварией и вы просыпаетесь от собственного крика.';
    }
  }
  ...
  private getHuntedLaw() {
    switch (this.d10.roll()) {
      ...
      case 5:
      case 6:
        return 'Вас разыскивают все местные силы.';
      case 7:
      case 8:
        return 'Вас разыскивает полиция всего штата.';
      case 9:
      case 10:
        return 'Вас разыскивает ФБР или аналогичные силы полиции.';
    }
  }
